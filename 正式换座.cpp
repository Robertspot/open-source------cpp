...
void sc(int x){
	switch (x){
		case 0:printf("m空座");break;
		case 1:printf("m弓汉羽");break;
		case 2:printf("m王江涵");break;
		case 3:printf("m王声宸");break;
		case 4:printf("m王俊达");break;
		case 5:printf("m王浩林");break;
		case 6:printf("m王梓安");break;
		case 7:printf("m王梓亦");break;
		case 8:printf("m王鹏然");break;
		case 9:printf("m王睿");break;
		case 10:printf("m刘田攸");break;
		case 11:printf("m刘传琦");break;
		case 12:printf("m孙林轩");break;
		case 13:printf("m吕越");break;
		case 14:printf("m孙福泽");break;
		case 15:printf("m张力洋");break;
		case 16:printf("m宋亦来");break;
		case 17:printf("m肖卓");break;
		case 18:printf("m陈泓嘉");break;
		case 19:printf("m吴佳儒");break;
		case 20:printf("m张家明");break;
		case 21:printf("m张霆伟");break;
		case 22:printf("m张赫禹");break;
		case 23:printf("m郑云骜");break;
		case 24:printf("m林瑞涵");break;
		case 25:printf("m赵万鸣");break;
		case 26:printf("m赵明泽");break;
		case 27:printf("m姜哲");break;
		case 28:printf("m郝瑞升");break;
		case 29:printf("m秦栋");break;
		case 30:printf("m栾胜臣");break;
